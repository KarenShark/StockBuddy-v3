...
from stockbuddy.adapters.models.factory import (
    create_embedder,
...
def create_model_with_provider(
    ...
    **kwargs,
    ...
    try:
        from stockbuddy.adapters.models.factory import get_model_factory
        from stockbuddy.config.manager import ProviderConfig, get_config_manager
    except Exception:
