"""StockBuddy Asset Data Adapter Module.
...
Usage Example:
    ```python
    from stockbuddy.adapters.assets import (
        get_adapter_manager, get_watchlist_manager
    )
    from stockbuddy.services.assets import (
...
# Note: High-level asset service functions have been moved to stockbuddy.services.assets
