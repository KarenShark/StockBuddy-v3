...
class ExchangeType(str, Enum):
    ...
    PAPER = "paper"  # Simulated trading (crypto)
    ...
    HK_STOCK_PAPER = "hk_stock_paper"  # HK stock simulated trading
    HK_STOCK_LIVE = "hk_stock_live"  # HK stock live trading (future: Futu, IB, Tiger)
