"""Database initialization script for StockBuddy Server."""
...
from stockbuddy.server.config.settings import get_settings
from stockbuddy.server.db.connection import DatabaseManager, get_database_manager
from stockbuddy.server.db.models.agent import Agent
from stockbuddy.server.db.models.base import Base
from stockbuddy.server.db.repositories.asset_repository import get_asset_repository
from stockbuddy.server.services.assets import get_asset_service
from stockbuddy.utils.path import get_agent_card_path
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Initialize StockBuddy database")
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    logger.info("StockBuddy Database Initialization")
    logger.info("=" * 50)
