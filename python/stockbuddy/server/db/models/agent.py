"""
StockBuddy Server - Agent Models

This module defines the database models for agents in the StockBuddy system.
"""
...
class Agent(Base):
    """
    Agent model representing an AI agent in the StockBuddy system.
