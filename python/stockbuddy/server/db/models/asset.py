"""
StockBuddy Server - Asset Models

This module defines the database models for assets in the StockBuddy system.
"""
...
class Asset(Base):
    """
    Asset model representing financial assets in the StockBuddy system.
