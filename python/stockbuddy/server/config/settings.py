"""Settings configuration for StockBuddy Server."""
...
def _get_project_root() -> str:
    ...
    Layout assumption: this file is at repo_root/python/stockbuddy/server/config/settings.py
...
def _default_db_path() -> str:
    ...
    return f"sqlite:///{os.path.join(repo_root, 'stockbuddy.db')}"
...
class Settings:
    ...
    def __init__(self):
        ...
        self.APP_NAME = os.getenv("APP_NAME", "StockBuddy Server")
        ...
        self.DATABASE_URL = os.getenv("STOCKBUDDY_SQLITE_DB", _default_db_path())
