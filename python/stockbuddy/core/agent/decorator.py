...
from stockbuddy.core.agent.card import find_local_agent_card_by_agent_name
from stockbuddy.core.constants import DEPENDENCIES
...
from stockbuddy.utils import parse_host_port
        ...
        try:
            ...
            async for response in query_handler(
                ...
                if EventPredicates.is_tool_call(response_event):
                    ...
                    metadata["tool_args"] = response.metadata.get("tool_args")
