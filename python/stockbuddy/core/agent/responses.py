...
class _StreamResponseNamespace:
    ...
    def tool_call_started(self, tool_call_id: str, tool_name: str, tool_args: Optional[str] = None) -> StreamResponse:
    ...
    def reasoning(self, content: str) -> StreamResponse:
        """Create a reasoning/thinking response.

        Args:
            content: The reasoning or thinking content

        Returns:
            StreamResponse with REASONING event
        """
        return StreamResponse(
