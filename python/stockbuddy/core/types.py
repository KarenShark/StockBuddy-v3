...
from stockbuddy.utils.uuid import generate_item_id
...
class ToolCallPayload(BaseModel):
    ...
    Contains identifiers, arguments, and optional result content produced by the tool.
    """
    ...
    tool_args: Optional[str] = Field(
        None,
        description="The arguments/parameters passed to the tool, if any.",
    )
...
class ComponentType(str, Enum):
    ...
    EXECUTION_PLAN = "execution_plan"  # Dynamic TODO list display
