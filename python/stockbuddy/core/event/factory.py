...
from stockbuddy.utils.uuid import generate_item_id, generate_uuid
...
class ResponseFactory:
    ...
    def task_started(
        ...
        Args:
            ...
            task_title: Optional title/description of the task being executed.

        Returns:
            TaskStartedResponse with agent role and task details.
        """
        # Build metadata with task details for frontend display
        metadata = {}
        if task_title:
    ...
    def tool_call(
        ...
        Args:
            ...
            tool_args: Optional arguments/parameters passed to the tool.
